...
import "./scss/Second_Layout.scss";
...
const Second_Layout = () => {
  return (
    <div className="Report__Container">
      <nav className="Report-Second__Sidebar">
        <Link to="/">
      ...
      <header className="Report-Second__Title">
        <h1>🔍 OTT 서비스 연령대별 이용시간</h1>
      </header>
      <article className="Report-Second__Graph">
        <h2>OTT 서비스 이용률</h2>
      </article>
      <article className="Report-Second__Graph">
        <h2>OTT 서비스별 이용률</h2>
      </article>
      <article className="Report-Second__Chart">차트</article>
      <article className="Report-Second__Chart">차트</article>
      <article className="Report-Second__Source">
        <h3>출처 : 미디어통계포털 2019, 2020 방송매체이용행태조사</h3>
      </article>
      <article className="Report-Second__Insight">
        <h3>인사이트</h3>
        <p>
