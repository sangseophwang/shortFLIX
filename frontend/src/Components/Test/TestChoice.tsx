    ...
    return (
        <div id='TestChoice'>
            ...
            <div className='choices'>
                <SelectButton id='1' detail='내 취향을 잘 알고 있다면 이 버튼을 눌러주세요.'>내 취향에 맞는 컨텐츠 찾기</SelectButton>
                <SelectButton id='2' detail='내 취향을 아직 모르겠다면 이 버튼을 눌러주세요.'>아무거나 추천</SelectButton>
            </div>
                </>
            ):(
                <>
            ...
            <div className='choices'>
                <SelectButton id='3' detail='오늘은 새로운 게 당긴다면!'>완전 랜덤으로 추천</SelectButton>
