...
import heart_fill from '../Common/Image/heart_fill.png'
import full_star from '../Common/Image/full_star.svg'
import half_star from '../Common/Image/half_star.svg'
import empty_star from '../Common/Image/empty_star.svg'
import chevron_big_left from '../Common/Image/chevron_big_left.svg'
import chevron_big_right from '../Common/Image/chevron_big_right.svg'
...
export default function WatchVideoContent( { videoDetail, setPage }: WatchVideoContentProps) {
    ...
    return (
        <div id='WatchVideoContent'>
            ...
            <div className='videoDetail'>
                <img src={videoDetail.poster} alt={`${videoDetail.title} 포스터`} className='videoPoster' />
                <div className='videoDesc'>
                    <div className='videoTitle'>{videoDetail.title}</div>
                    <p>
                        장르: {videoDetail.genre.join(', ')}
                    </p>
                    <p>
                        러닝타임: {videoDetail.runningTime}
                    </p>
                    <p>
                        <span className='starRating'>
                            {[...Array(fullStarNum)].map((e,i) => <img src={full_star} key={`star-${i}`} />)}
