...
def filter_content(request_data):
    ...
    if result['contentType'] == []:
        result['contentType'] = [ "영화","드라마","다큐멘터리","애니메이션"]
    if result['year'] == []:
        result['year'] = ["2000년 이전", "2000년-2009년","2010년-2019년", "2020년 이후"]
    if result['genre'] == []:
        result['genre'] = ['전쟁', '드라마', '판타지', '역사', '로맨스', 'SF', '코미디', '애니메이션', '다큐멘터리', 
                       '음악', '액션', 'Reality TV', '범죄', '가족', '스포츠', '스릴러', 'Made in Europe', '공포', '서부']
    if result['keyword'] == []:
        result['keyword'] = ['야구', '형님', '모험', '임무', '웃음', '사건', '집행', '아이', '경쟁', '연주', 
                         '대원', '동생', '인간', '피아노', '복수', '덴마크', '학교', '여자', '마약', '시리즈', 
                         '운명', '무대', '살인', '나치', '우정', '좀비', '감시', '작전', '존재', '노예', 
                         '쇼', '마음', '아들', '사랑', '소년', '비밀', '변호사', '돈', '죽음', '경찰', 
                         '배신자', '초원', '공개', '그녀', '딸', '형제', '최고', '시간', '과거', '인류', 
                         '중학교', '형사', '마을', '드래곤', '게임', '아버지', '거인', '친구', '음식', '레이스', 
                         '기록', '영국', '인생', '소녀', '우리', '미래', '조직', '퀸', '제국', '부대', '테러', '레슬링', 
                         '조선', '사람', '선수', '전설', '미국', '요괴', '남자']
